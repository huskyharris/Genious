            ...
            <div className="row justify-content-center wow fadeInUp" data-wow-delay=".3s">
               <div className="col-lg-8">
                  <div className="section-title style-4 text-center">
                     <span className="section-subtitle">MKFABRICS</span>
                     <h2 className="section-main-title mb-45">OUR TEAM</h2>
                  </div>
               </div>
            </div>
            ...
            {TeamList &&
               <div className="row">
                {TeamList.slice(0, 2).map((item, num) => (
                  <div className="col-xl-6 col-lg-4 col-md-6 col-sm-6" key={num}>
