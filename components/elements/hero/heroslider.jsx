...
const HeroSlider = () => {
    ...
    const SliderItem = [
        {
            id: 1,
            sliderBg: '/assets/img/banner/B1.jpg',
            sliderSubtitle: 'Mkfabrics',
            sliderTitle: 'PVC & LEATHER',
            sliderbtn: 'Contact Us',
            sliderbtn2: 'About Us',
        },
        {
            id: 2,
            sliderBg: '/assets/img/banner/B2.jpg',
            sliderSubtitle: 'PVC & LEATHER',
            sliderTitle: 'Import and Export',
            sliderbtn: 'Contact US',
            sliderbtn2: 'About Us',
        },
        {
            id: 3,
            sliderBg: '/assets/img/banner/B3.jpg',
            sliderSubtitle: 'Locations',
            sliderTitle: 'Germany & Ghana',
            sliderbtn: 'Contact Us',
            sliderbtn2: 'About Us',
        }
    ];
