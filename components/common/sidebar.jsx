                    ...
                    <div className="side-info-content">
                        <div className="offset-widget offset-logo mb-40">
                            <div className="row align-items-center">
                                <div className="col-9">
                                    <Link href="/"><a><img src="/assets/img/logo/M2.png" alt="Logo" /></a></Link>
                                </div>
                            ...
                            <div className="footer-support">
                                <div className="irc-item support-meta">
                                    ...
                                    <div className="irc-item-content">
                                        <p></p>
                                        <div className="support-number"><a href="tel:98965963168">+49 179 1132627</a></div>
                                    </div>
                                </div>
                                <div className="irc-item support-meta mt-20">
                                    ...
                                    <div className="irc-item-content">
                                        <p></p>
                                        <div className="support-number"><a href="tel:98965963168">+49 176 24329949</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
