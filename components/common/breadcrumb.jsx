...
const Breadcrumb = ({ breadTitle, breadSubtitle, breadHome, breadMenu }) => {
   return (
      <section className="page-title-area" style={{ background: "url(https://images.pexels.com/photos/6444240/pexels-photo-6444240.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" }}>
